  ...
  if (isDragging) {
    return (
      <div
        ref={setNodeRef}
        style={style}
        className=" opacity-30 bg-mainBackgroundColor p-2.5 h-[100px] min-h-[100px]
  ...
  cursor-grabs relative"
      >
        <textarea
          className="
    h-[90%]
    w-full resize-none border-none rounged bg-transparent
    text-white focus:outerline-none
    "
          value={task.content}
          autoFocus
